        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppointmentRoom = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrdersandEquipment = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientStaff", x => new { x.PatientsPatientID, x.StaffsStaffID });
                    table.ForeignKey(
                        name: "FK_PatientStaff_Patient_PatientsPatientID",
                        column: x => x.PatientsPatientID,
                        principalTable: "Patient",
                        principalColumn: "PatientID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PatientStaff_Staff_StaffsStaffID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientStaff_StaffsStaffID",
                table: "PatientStaff",
