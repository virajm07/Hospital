...
namespace Hospital.Controllers
{
    public class StaffsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StaffID,FirstName,LastName,DOB,ContactInfo,CriminalHistory,MedicalHistory,HealthConditions,WorkSchedule")] Staff staff)
        {
            if (id != staff.StaffID)
            {
                return NotFound();
